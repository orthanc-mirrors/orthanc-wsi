...
namespace OrthancWSI
{
  ...
  public:
    static const ViewerConfiguration& GetInstance();

    bool IsIIIFEnabled() const;

    std::string GetOrthancPublicUrl() const;

    std::string GetIIIFPublicUrl() const;

    bool IsServeMirador() const;
